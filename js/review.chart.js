...
function getLevel(objectLevel) {
  ...
  switch (level) {
    case 1:
      return 'Väldigt stressad (1)';
      break;
    case 2:
      return 'Ganska stressad (2)';
      break;
    case 3:
      return 'Neutral (3)';
      break;
    case 4:
      return 'Ganska avslappnad (4)';
      break;
    case 5:
      return 'Väldigt avslappnad (5)';
      break;
  }
}
...
function generateChart(object) {
  ...
  var barChartData = {
      ...
      yLabels: ['Väldigt stressad', 'Ganska stressad', 'Neutral', 'Ganska avslappnad', 'Väldigt avslappnad'],
      datasets: [
          {
          label: 'Pre-task',
